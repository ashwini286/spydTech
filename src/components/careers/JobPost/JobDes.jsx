...
const JobDes = ({currentPage}) => {
  return (
    <>
    {/* <p className="md:text-5xl font-bold text-2xl pt-4 border-b-2 border-black text-center ">Job Description</p>  */}
    <div className=" flex  justify-start items-center flex-col  lg:w-[500px] lg:mr-[350px]">
          <div>
            <p className="md:text-5xl font-bold text-2xl pt-4 border-b-2 border-black text-center ">Job Description</p>
            </div>
          ...
          {currentPage === "Android" && (
              <div>
                <p className="text-2xl font-bold md:py-4 pt-8"> Android Developer </p>
                ...
                <div>
                  <div>
                    <p className="text-2xl font-bold py-4">iOS Developer:</p>
                  </div>
                  <div>
                ...
                <div>
                  <div>
                    <p className="text-2xl font-bold py-4">Good To Have:</p>
                  </div>
                  <div>
        ...
        <div className='flex  justify-start pb-8'> 
          ...
          <button className='bg-[#008080] text-white py-2 px-8 rounded-md  shadow-lg shadow-cyan-700 mt-4 hover:bg-[#008080] hover:scale-105 transition-all duration-500'>Apply Now</button>
            ...
            {currentPage === "fullstack" && (
              <div>
                <p className="text-2xl font-bold md:py-4 pt-8">Full Stack Developer</p>
                <div>
                  <li>Proficient in core Java with excellent knowledge.</li>
                  <li>Hands-on experience in the complete life cycle of Android application development.</li>
                  <li>Strong understanding of RESTful web services.</li>
                ...
                <div>
                  <div>
                    <p className="text-2xl font-bold md:py-4 pt-8">Backend Development:</p>
                  </div>
                  <div>
                ...
                <div>
                  <div>
                    <p className="text-2xl font-bold md:py-4 pt-8">Frontend Development:</p>
                  </div>
                  <div>
        ...
        <div className='flex  justify-start pb-8'> 
          ...
          <button className='bg-[#008080] text-white py-2 px-8 rounded-md  shadow-lg shadow-cyan-700 mt-4 hover:bg-[#008080] hover:scale-105 transition-all duration-500'>Apply Now</button>
            ...
            {currentPage === "ReactJs" && (
              <div>
                <p className="text-2xl font-bold md:py-4 pt-8">React JS Developer</p>
                <div>
        ...
        <div className='flex  justify-start pb-8'> 
          ...
          <button className='bg-[#008080] text-white py-2 px-8 rounded-md  shadow-lg shadow-cyan-700 mt-4 hover:bg-[#008080] hover:scale-105 transition-all duration-500'>Apply Now</button>
            ...
            {currentPage === "Java" && (
              <div>
                <p className="text-2xl font-bold md:py-4 pt-8">Java Developer</p>
                <div>
                  <li>Proficient in core Java with excellent knowledge.</li>
        ...
        <div className='flex  justify-start pb-8'> 
          ...
          <button className='bg-[#008080] text-white py-2 px-8 rounded-md  shadow-lg shadow-cyan-700 mt-4 hover:bg-[#008080] hover:scale-105 transition-all duration-500'>Apply Now</button>
            ...
            {currentPage === "PHP" && (
              <div>
                <p className="text-2xl font-bold md:py-4 pt-8">PHP Developer</p>
                <div>
        ...
        <div className='flex  justify-start pb-8'> 
          ...
          <button className='bg-[#008080] text-white py-2 px-8 rounded-md  shadow-lg shadow-cyan-700 mt-4 hover:bg-[#008080] hover:scale-105 transition-all duration-500'>Apply Now</button>
            ...
            {currentPage === "Business" && (
              <div>
                <p className="text-2xl font-bold md:py-4 pt-8">Business Development Manager</p>
                <div>
                ...
                <div>
                  <p className="text-2xl font-bold py-4">Technical Skills:</p>
                  <li>Proficient in core Java with excellent knowledge.</li>
                  <li>Hands-on experience in the complete life cycle of Android application development.</li>
                  <li>Strong understanding of RESTful web services.</li>
                  <li>Good knowledge of Android SDKs.</li>
