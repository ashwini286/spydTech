    ...
    <>
      <div className='md:px-16 pl-4'>
        ...
        <div className='text-lg text-[#656565]'>
          ...
          <p className='pt-4'>Web & Mobile Products developed by  <span></span>SPY D TECHNOLOGY  showcase our commitment to creating solutions that stand out in the market. From feature-rich mobile apps to responsive websites, our products are crafted with precision and a user-centric approach, ensuring that they meet the evolving needs of businesses and end-users alike.</p>
          ...
          <p className='pt-4'>Augmented & Virtual Reality are areas where  <span></span>SPY D TECHNOLOGY  pushes the boundaries of possibility. Leveraging AR and VR technologies, we create immersive experiences that redefine how users interact with digital content. From virtual tours to augmented reality applications, our solutions elevate engagement and deliver a new dimension to digital experiences.</p>
          <p className='pt-4'>Artificial and Machine Learning represent the future of intelligent computing, and  <span></span>SPY D TECHNOLOGY  is at the forefront of harnessing these technologies for the benefit of our clients. Our expertise in developing AI and ML solutions empowers businesses to automate processes, gain valuable insights, and make data-driven decisions, enhancing overall efficiency and productivity.</p>
          <p className='pt-4' >Design Thinking Innovation is ingrained in our approach to problem-solving. At  <span></span>SPY D TECHNOLOGY , we believe in the power of creativity and user-centric design to drive innovation. Our design thinking processes ensure that our solutions not only meet technical requirements but also resonate with end-users, delivering exceptional experiences.</p>
