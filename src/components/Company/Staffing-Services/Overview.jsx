  ...
  return (
    ...
    <div class="container mx-auto py-16 dark:text-white">
        <div class="text-center">
            <h2 class="font-bold text-2xl md:text-4xl my-4">Solutions That Funnel Results</h2>
            <div class="max-w-2xl md:max-w-4xl mx-auto dark:text-gray-300">
                <p>
                Driving results depend on a number of factors over and above organic or paid traffic.
                 Effective lead capture techniques, 
                 data nurturing & intelligent alert technology all drive higher percentages of conversion and results.
