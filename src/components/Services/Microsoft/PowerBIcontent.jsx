...
function PowerBIcontent() {
  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto text-center" data-aos="fade-up-left">
    ...
    <h3 className='text-3xl pt-10' data-aos="fade-up-left">Here's how you can enhance your Power BI content for <a className='text-transparent bg-clip-text bg-gradient-to-r from-[#b91c1c] via-blue-800 to-[#7c2d12]'>SpY D: </a></h3>
    ...
    <ul role="list"
      ...
      <li data-aos="fade-up-left" class="rounded-2xl border hover:border-b-8 p-8 shadow-4xl   hover:border-b-[#14532d] hover:scale-105  transition duration-500">
      ...
      <li data-aos="fade-up-left" class="rounded-2xl border hover:border-b-8  shadow-4xl   hover:border-b-[#14532d] hover:scale-105  transition duration-500 p-8 shadow-xl ">
        <h3 class="font-bold text-lg text-gray-900 flex items-center">
      ...
      <li data-aos="fade-up-left" class="rounded-2xl border hover:border-b-8 p-8 shadow-4xl   hover:border-b-[#14532d] hover:scale-105  transition duration-500 shadow-xl">
        <h3 class="font-bold text-lg text-gray-900 flex items-center">
  ...
  <div class="relative my-12 flex w-full flex-col items-center sm:mt-24" data-aos="fade-up-left">
  ...
  <span class="mt-8 max-w-lg text-center text-xl leading-relaxed text-gray-800" data-aos="fade-up-left">
  ...
  <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-0 sm:gap-x-4" data-aos="fade-up-left">
    <a href=""
