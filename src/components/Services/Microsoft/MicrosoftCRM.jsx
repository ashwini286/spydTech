  ...
  return (
    ...
    <div className="flex flex-col md:flex-row py-10 p-20">
        ...
        <div class="w-full max-w-2xl my-4 mx-auto">
          <div class="border-2 border-indigo-500 p-4 md:p-6 rounded-lg text-center">
            ...
            <p class="text-lg mb-4 text-gray-700" data-aos="fade-down">
              ...
              <br />
              provides Customer Relationship Management (CRM) solutions
              specially designed by our experts to meet our clients'
              ever-demanding needs. We utilize our domain expertise to implement
              SMBs and LMEs level solutions that meet all the business needs of
              our clients. With our deep knowledge of CRM processes, we are
              experts in building multichannel customer interactive systems and
              Microsoft CRM architecture that reduces the total cost involved in
              the actual development and enhances the overall services.
            </p>
        ...
        <div className="flex flex-col gap-4 lg:flex-row items-center justify-center lg:justify-start md:ml-10">
          ...
          >
            ...
            <div className="flex items-center">
              <span className="text-[#38bdf8] lg:text-xl mr-2">&gt;</span>
              <p className="text-sm lg:text-base">
                Security through compliance program and highly secure data
                centers
              </p>
            </div>
            <div className="flex items-center">
                ...
                <div class="p-6 bg-grey" data-aos="fade-down">
                  <div class="leading-relaxed">
                    ...
                    <p class="mt-4">
                      ...
                      success through our CRM solutions and services and helped
                      us to explore a new dimension to customer service. We also
                      focus on leveraging the platform to support any
                      relationship scenario you want to develop with our CRM
                      services.
                    </p>
                    <p class="mt-4"></p>
                    <p>
        ...
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-5">
          <div
            class="relative isolate overflow-hidden bg-blue-800 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32"
            data-aos="fade-up"
          >
