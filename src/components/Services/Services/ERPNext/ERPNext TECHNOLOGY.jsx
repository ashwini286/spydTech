      ...
      <div className=" p-4 bg-white rounded-xl">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500 ">
            <img src={IMG12} className="w-[85%]" alt="Background Image" data-aos="fade-up-right"  />
            <h2 className="text-xl font-bold mb-2 p-5" data-aos="fade-up-right">ERPNext Consulting</h2>
          ...
          {/* Card 2 */}
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500 ">
            <img src={IMG1} className="w-[90%]" alt="Background Image" data-aos="fade-up-right"  />
            <h2 className="text-xl font-bold  p-4" data-aos="fade-up-right" >ERPNext Implementation</h2>
            <p className="w-[100%]  text-justify tracking-wider" data-aos="fade-up-right">
