      ...
      <div className=" p-4 bg-white rounded-xl">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500 ">
            <img src={IMG12} className="w-[85%]" alt="Background Image" />
            <h2 className="text-xl font-bold mb-2 p-5">ERPNext Consulting</h2>
            <p className="w-[100%]  text-justify tracking-wider">
          ...
          {/* Card 2 */}
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500 ">
            <img src={IMG1} className="w-[90%]" alt="Background Image" />
          ...
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500 ">
            ...
            <p className="w-[100%]  tracking-wider">
          ...
          {/* Card 5 */}
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500 ">
            <img src={IMG4} className="w-[85%]" alt="Background Image" />
            <h2 className="text-xl font-bold mb-2 p-5">
          ...
          {/* Card 6 */}
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500">
            <img src={IMG5} className="w-[85%]" alt="Background Image" />
            <h2 className="text-xl font-bold mb-2 p-5">
          ...
          {/* Card 7 */}
          <div className="bg-white p-4 rounded-lg hover:scale-105 transition-all duration-500">
            <img src={IMG6} className="w-[85%]" alt="Background Image" />
            <h2 className="text-xl font-bold mb-2 p-5">
