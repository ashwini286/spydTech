...
function ERPNext () {
  return (
    ...
    <img src={IMG} alt="Background Image" class="absolute inset-0 w-full h-[80vh]  object-cover filter blur-sm" />
    <div class="absolute inset-0 h-[80vh] bg-black bg-opacity-50 "></div>
    <div class="absolute inset-0  flex flex-col md:flex-row items-center justify-center ml-10">
        <div class="text-4xl text-white font-bold w-full p-10">Our Services</div>
        <div class="text-xl text-white mt-4 -ml-10 md:p-10">Building Cost-Effective Digital Business Capabilities around the ERPNext, 
...
<div className='md:h-[550px]'>
   ...
   <div className="mt-8 p-4 bg-white rounded-xl">
        ...
        />
            ...
            <p className='w-[100%]  text-justify tracking-wider'>Our Consultants gather all the necessary details about your company,
        ...
        />
            ...
            <p className='w-[100%]  text-justify tracking-wider'>We focus on organizing the overall structure and behavior of all the doctypes, 
        ...
        />
            ...
            <p className='w-[100%]  text-justify tracking-wider'>For the out of box requirement, Our technical team prepares prototypes for clients, 
        ...
        />
            ...
            <p className='w-[100%]  tracking-wider'>We help small businesses and NGOs to start their digital transformation journey and a presence in the digital world with a dynamic, 
        ...
        />
            ...
            <p className='w-[100%]  text-justify tracking-wider'>We help in the seamless integration of the eCommerce store with a modern, 
        ...
        />
            ...
            <p className='w-[100%]  text-justify tracking-wider'>We are experts in any kind of third-party integration with ERPNext, 
        ...
        />
            ...
            <p className='w-[100%]  text-justify tracking-wider'>DATA is NEW OIL. And, Having real-time insights from each decision point, 
