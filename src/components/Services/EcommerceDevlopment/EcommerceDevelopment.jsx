   ...
   return (
      <>
         ...
         <div>
            ...
            <div className='p-10 text-1xl w-[95%] text-center tracking-widest  text-black'>
         ...
         <h1 className='text-3xl pb-4 pl-4 text-bold  text-black'>The value we add to our clients:</h1>
