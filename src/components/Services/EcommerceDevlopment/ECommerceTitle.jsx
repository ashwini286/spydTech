    ...
    <>
     <Navbarupp />
      ...
      <div className='flex items-center justify-center'>
        <div className='text-center text-2xl pt-16 w-[850px] mt-8 font-bold border-b-4 border-gray-500 drop-shadow-2xl'>Empower Your Business with Seamless eCommerce Solutions: Unleashing the Future of Digital Commerce</div>
      </div>
      ...
      <div className='flex flex-col md:flex-row  items-center justify-center gap-8 '>
                ...
                <div className='md:w-[620px] md:h-[500px] text-white flex justify-center items-justify flex-col ' data-aos="fade-down">
                    <div>
                        <img src="https://www.heliossolutions.co/blog/wp-content/uploads/2015/09/magento-development.png" alt="" />
...
<div className='flex flex-col-reverse md:flex-row  items-center justify-center'>
                <div className='md:w-[620px] md:h-[500px] text-white flex justify-center items-justify flex-col ' data-aos="fade-down">
                    <div>
                        <img src="https://theinvestorsbook.com/wp-content/uploads/2020/03/features-of-m-commerce-2.jpg" alt="" />
                    </div>
...
{/*  E-Commerce */}
    ...
    In the digital era, eCommerce stands as the gateway to a revolutionary shopping experience, transforming the way we buy and sell goods and services. At its core, eCommerce, or Electronic Commerce, refers to the online exchange of products and services, fostering a virtual marketplace that transcends geographical boundaries. Let's explore the key elements that define and characterize the essence of eCommerce.
                ...
                <div className='md:w-[620px] md:h-[500px] text-white flex justify-center items-justify flex-col ' data-aos="fade-down">
                    <div>
                        <img src="https://www.thethrive.in/wp-content/uploads/2020/09/16092020-6.jpg" alt="" />
                        {/* <img src="https://e7.pngegg.com/pngimages/548/731/png-clipart-graphy-others-web-design-sticker.png" alt="" /> */}
                    </div>
                </div>
            </div>
...
<div className='mt-10 md:px-4 mb-10 bg-[#242B40] rounded-lg md:mx-8 pt-8' data-aos="fade-down">
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 md:px-8 text-white'>
    <div className='flex items-center w-[89%] gap-4 pb-8 pl-6'>
      ...
      <p>Embark on eCommerce excellence with SPYD Tech. Our skilled team uses cutting-edge technologies to fortify web applications, ensuring utmost security for your digital assets.</p>
    </div>
    <div className='flex items-center w-[89%] gap-4 pb-8 pl-6'>
      <p><BlurCircularIcon /></p>
      <p>At SPYD Tech, we exceed industry standards. Our advanced security measures in frontend technologies secure your data, providing a foundation for all online business activities.</p>
    </div>
    <div className='flex items-center w-[89%] gap-4 pb-8 pl-6'>
      <p><BlurCircularIcon /></p>
      <p>Experience seamless integration with our modular frontend solutions. SPYD Tech ensures swift implementation, enhancing the efficiency of your eCommerce ecosystem.</p>
    </div>
    <div className='flex items-center w-[89%] gap-4 pl-6 pb-16'>
      <p><BlurCircularIcon /></p>
      <p>Committed to excellence, SPYD Tech strengthens security and optimizes development budgets. Trust us for secure, scalable, and cost-effective eCommerce solutions tailored to your business needs.</p>
    </div>
  </div>
</div>
