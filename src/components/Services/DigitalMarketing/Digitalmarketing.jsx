      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0  flex flex-col  items-center justify-center text-center text-white">
          <h1 className="text-2xl font-bold md:text-4xl py-4">
            Welcome to the Future of Surveillance with "Spy D Technology"
          </h1>
          <p className="text-lg md:w-[700px]">
            "Introducing SpyD, the cutting-edge solution revolutionizing
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-6">
                    <Link to="/Seo Services">
                      <button className="bg-pink-600 text-white py-2 px-4 rounded-md  shadow-lg shadow-pink-700 mt-4 hover:bg-pink-700">
                        Learn More
                      </button>
                    </Link>
                  </div>
      ...
      <div className="relative">
        ...
        <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 md:py-20 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
          ...
          <h2 class="mx-auto mt-8 max-w-xl text-base sm:text-lg text-white-500 dark:text-gray-300 leading-7 md:leading-9">
            Experience the future of surveillance with Spyd. Contact us to learn
            more about our products and services, and discover how Spyd can
            transform your security infrastructure for the better. Don't settle
            for outdated technology – embrace the future with Spyd.
          </h2>
     
              <button className="bg-orange-600 text-white py-2 px-4 rounded-md  shadow-lg shadow-orange-700 mt-4 hover:bg-orange-700">
              Get started
                      </button>
