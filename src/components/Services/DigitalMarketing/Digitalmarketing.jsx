    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-[35%] transform -translate-x-1/2 -translate-y-1/2 md:left-[35%] md:w-[50%] lg:w-[50%] text-start text-white font-bold px-5">
          ...
          >
            The Future of Surveillance with "SpY D Technology"
          </h1>
        </div>
      </div>

      <p
        className="text-lg  py-10 text-center p-10 font-semibold"
        data-aos="fade-up-right"
      >
        "Introducing SpY D Technology, the cutting-edge solution revolutionizing
        surveillance in the digital age. Say goodbye to outdated methods and
        hello to unprecedented security and intelligence with our
      ...
      <div className="relative overflow-hidden  pt-16 pb-32 space-y-24">
        <div className="relative">
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
              ...
              <div>
                <div className="mt-6">
                  ...
                  >
                    ...
                    to optimize a website's technical configuration, content
                  ...
                  <div className="mt-6" data-aos="fade-up-right">
                    <Link
                      to="/services/seo_services"
                      className="bg-[#8543ee] text-white py-2 px-4 rounded-md  shadow-lg shadow-purple-600 mt-4 hover:bg-[#3a0ca3] "
                    >
                      Learn More
                    </Link>
                  </div>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div
                className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0"
                data-aos="fade-up-right"
              >
                <img
                  loading="lazy"
        ...
        <div className="relative">
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
              ...
              <div>
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg " data-aos="fade-up-right">
                    ...
                    traction from specific audience segments. With PPC,
                    advertisers only pay each time a user clicks on the PPC ads
                    -- hence the name pay-per-click.
                  </p>
                  <p className="text-lg pb-5 text-black">
                    People usually think of Google PPC when hearing or talking
                    about what is pay per click. But pay-per-click goes beyond
                    the Google search engine results pages (SERPs) and the
                    Google Display Network. Social media sites, such as YouTube,
                    Facebook, Pinterest and LinkedIn, also use the pay per click
                    model.
                  </p>
                  <div className="mt-6" data-aos="fade-up-right">
                    <Link
                      to="/services/ppc_management_services"
                      className="bg-[#8543ee] text-white py-2 px-4 rounded-md  shadow-lg shadow-purple-600 mt-4 hover:bg-[#3a0ca3] "
                    >
                      Learn More
                    </Link>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div
                className="ml-5 pr-6 md:nl-5 lg:relative lg:m-0 lg:h-full lg:px-0"
                data-aos="fade-up-right"
              >
                <img
          ...
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
            <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
              <div>
                <div className="mt-6">
                  <h2
                    className="text-3xl font-bold tracking-tight t"
                    data-aos="fade-up-right"
                  >
                  ...
                  <div className="mt-6" data-aos="fade-up-right">
                    <Link
                      to="/services/smm_&_content_writing"
                      className="bg-[#8543ee] text-white py-2 px-4 rounded-md  shadow-lg shadow-purple-600 mt-4 hover:bg-[#3a0ca3] "
                    >
                      Learn More
                    </Link>
      ...
      <div className="relative">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
          <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 lg:col-start-2">
            <div>
              <div className="mt-6">
                ...
                <p className="mt-4 text-lg " data-aos="fade-up-right">
                  As the world has witnessed a great shift of customer’s
                  preference from a conventional advertising world to the
                  digital sphere, the growing use of internet, technology &
                  digital media has raised the dependency of people on the
                  online market. Due to this, the brands are rooting their base
                  in various digital platforms, since marketing is one of the
                  most essential aspect of a business plan.
                </p>
                <div className="mt-6" data-aos="fade-up-right">
                  <Link
                    to="/services/ppc_management_services"
          ...
          <div className="mt-12 sm:mt-16 lg:mt-0">
            <div
              className="ml-5 pr-6 md:ml-5 lg:relative lg:m-0 lg:h-full lg:px-0"
              data-aos="fade-up-right"
            >
              <img
                alt="Inbox user interface"
        ...
        <div className="">
          <div
            data-aos="fade-up-right"
            class="p-10 flex flex-1 w-full flex-col items-center justify-center text-center  bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800"
          >
            <a
              href=""
              class="border border-white-700 dark:border-gray-900 rounded-lg py-2 px-4 text-white-400 dark:text-gray-900 text-sm mb-5 md:mb-10 transition duration-300 ease-in-out hover:text-gray-500 dark:hover:text-gray-900"
            >
              Get Started Today
            </a>
            <h1
              data-aos="fade-up-right"
              class="mx-auto max-w-4xl font-display text-3xl md:text-5xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-5xl"
            >
              ...
              <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
                ...
                <span data-aos="fade-up-right" class="relative">
            ...
            <h2
              data-aos="fade-up-right"
              class="mx-auto mt-8 max-w-xl text-base sm:text-lg text-white-500 dark:text-gray-300 leading-7 md:leading-9"
            >
              Experience the future of surveillance with SpY D. Contact us to
              learn more about our products and services, and discover how SpY D
              can transform your security infrastructure for the better. Don't
              settle for outdated technology – embrace the future with SpY D.
            </h2>
            <a
              data-aos="fade-up-right"
              class="bg-orange-600 dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 mt-8 md:mt-12 hover:bg-orange-500 dark:hover:bg-gray-600 transition"
              href=""
            >
              Get started
            </a>
