  ...
  return (
    <>
      ...
      <div className='relative '>
        <img
          // src={IMG}
          src="https://ebizfiling.com/wp-content/uploads/2023/02/middle-infographic.png"
          className='pb-20 w-[100%] h-[40rem] '
          style={{ filter: "brightness(100%)" }}
        />
        <div class="absolute inset-0 h-[80vh] bg-black bg-opacity-50 rounded-2xl"></div>
        <div className='absolute text-center justify-center items-center -mt-[25%] text-white p-10 text-4xl font-bold'>
    ...
    <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
      ...
      <div className='bg-teal-500 rounded-2xl p-10'>
