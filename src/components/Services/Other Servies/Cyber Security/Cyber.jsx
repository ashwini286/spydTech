      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-[35%] transform -translate-x-1/2 -translate-y-1/2 md:left-[35%] md:w-[50%] lg:w-[50%] text-start text-white font-bold px-5">
          ...
          <h1 className="text-2xl md:text-4xl lg:text-4xl">
            ...
            <a
              data-aos="fade-up"
              className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-white"
            >
              "SpY D Technology"
            </a>{" "}
          ...
          <p className="text-xl">
            "At Spy D Technology, we understand the critical importance of
            safeguarding your digital assets against evolving cyber threats.{" "}
          </p>
          <p className="text-lg md:w-[700px]">
            " Our comprehensive cyber security solutions are designed to protect
            your business, your data, and your reputation in an increasingly
            ...
            >
              <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                ...
                <div class="relative pl-16" data-aos="fade-up">
                  ...
                  <dd class="mt-2 text-base leading-7 text-white">
                    OYour security is our top priority. Our dedicated support
