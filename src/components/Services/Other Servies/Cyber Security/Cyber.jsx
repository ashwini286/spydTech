...
function Cyber() {
  ...
  return (
    <>
      ...
      <div className='text-center items-center bg-gradient-to-br from-blue-500 to-gray-900 text-white font-bold py-4 relative pt-10'
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center" data-aos="fade-up-right">
    ...
    Get Started Today</h2>
      ...
      <h1 class="lg:text-7xl text-4xl md:text-5xl font-bold tracking-tight text-white text-center">Why Choose
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-white">SpY D Technology?</span>
      </h1>
      <p class="mt-6 text-md text-white max-w-lg text-center">Don't wait until it's too late. Contact <a className='text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-white'>"SpY D Technology,,</a> today to learn more about how our cyber security solutions can help protect your business from cyber threats and vulnerabilities. Together, we can secure your digital future.</p>
    </div>
    <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl" data-aos="fade-up-right">
      <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        <div class="relative pl-16">
          ...
          <dd class="mt-2 text-base leading-7 text-white">Our team consists of highly skilled cyber security professionals with years of experience in protecting organizations of all sizes across various industries.</dd>
        </div>
        <div class="relative pl-16" data-aos="fade-up-right">
          <dt class="text-base font-semibold leading-7 text-white">
            <div class="absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-700"><svg
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" aria-hidden="true" class="h-6 w-6 text-white">
              ...
              </svg></div>Proactive Approach:
          </dt>
          <dd class="mt-2 text-base leading-7 text-white">We believe in staying ahead of the curve by continuously monitoring emerging threats and adapting our security measures to mitigate risks effectively.
          </dd>
        </div>
        <div class="relative pl-16" data-aos="fade-up-right">
          <dt class="text-base font-semibold leading-7 text-white">
            <div class="absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-700"><svg
              ...
              </svg></div>Client-Centric Solutions: 
          </dt>
          <dd class="mt-2 text-base leading-7 text-white">We understand that every organization has unique security needs and priorities. That's why we tailor our solutions to align with your specific requirements and objectives.</dd>
        </div>
        <div class="relative pl-16" data-aos="fade-up-right">
          <dt class="text-base font-semibold leading-7 text-white">
            <div class="absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-700"><svg
          ...
          <dd class="mt-2 text-base leading-7 text-white">OYour security is our top priority. Our dedicated support team is available round-the-clock to address any concerns or emergencies promptly.</dd>
        </div>
      </dl>
    </div>
  </div>
...
<div class="bg-gradient-to-br from-blue-500 to-gray-900 text-white h-screen">
    <div class="container mx-auto py-16 dark:text-white">
        <div class="text-center" data-aos="fade-up-right">
          <h1 className='text-gray-100 text-2xl font-bold'> WE ARE</h1>
            <h2 class="font-bold text-2xl md:text-4xl my-4"><a>SpY D Technology</a> Spend 30,000 Hours Per Year to Virus Threats</h2>
            <div class="max-w-2xl md:max-w-4xl mx-auto dark:text-gray-300">
                <p>
                "Fugiat nulla pariatur excepteur sint occaecat cupidatat non proident, 
                sunt in culpa rui officia deserunt mollit anim id est laborum incidunt ut labore et dolore magnam.
                </p>
            </div>
        </div>
        <div class="grid grid-cols-2 mx-auto max-w-xl md:max-w-2xl gap-4 my-4" data-aos="fade-up-right">
