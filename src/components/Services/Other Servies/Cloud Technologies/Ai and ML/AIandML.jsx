    ...
    <>
      ...
      <div className=" bg-gray-900 flex flex-col items-center text-center justify-center py-12">
        <h1
          ...
          className="text-5xl font-bold mb-8 animate-pulse  bg-gradient-to-r from-pink-600 via-purple-500 to-indigo-400 inline-block text-transparent bg-clip-text"
        >
          AI and Machine Learning
        </h1>
        <p
          className="text-white text-lg md:text-xl mb-8 md:px-2 "
          data-aos="fade-up-right"
        >
      ...
      <div className="bg-gray-900 text-white">
        <div className="p-10 space-x-5 animate-pulse flex flex-col md:flex-row">
          <img data-aos="fade-up-right" src={IMG2} className="shadow-2xl" />
          <div data-aos="fade-up-right">
            <h1 className="text-4xl" data-aos="fade-up-right">
              About AI...?
            </h1>
            <p className="text-xl" data-aos="fade-up-right">
              Artificial intelligence is the intelligence of machines or
              software, as opposed to the intelligence of other living beings,
              primarily of humans. It is a field of study in computer science
              that develops and studies intelligent machines. Such machines may
              be called AIs.
            </p>
            <Link to="/services/Ai2" data-aos="fade-up-right">
              <button className="bg-blue-500 rounded-md p-3 hover:bg-blue-800 hover:text-white mt-2">
                Read More
              </button>
            </Link>
          </div>
