            ...
            <div  data-aos="fade-up-right" className="tooltips absolute top-0 left-0 -translate-x-[100%] p-2 flex flex-col items-end gap-5 transition-all duration-300 group-hover:-translate-x-3/4">
              ...
              <ul className="flex flex-col items-start gap-2">
                <li className="inline-flex gap-2 items-center justify-center group-hover:delay-200 transition-all opacity-0 group-hover:opacity-100 group-hover:transition-all group-hover:duration-500">
                  <svg stroke-linejoin="round" stroke-linecap="round" stroke-width="3" className="stroke-[#495c48]" stroke="#000000" fill="none" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                    <polyline points="22 4 12 14.01 9 11.01"></polyline>
                  </svg>
                  <p className="text-xs font-semibold text-[#495c48]">Brief overview of SPYD, its purpose, and how it addresses modern challenges.</p>
                </li>
