      ...
      <div className='items-center'>
        <div className="product-card w-full md:w-[700px] lg:w-[700px] mx-auto rounded-md shadow-xl overflow-hidden z-[200] relative cursor-pointer snap-start shrink-0 py-8 px-6 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group">
          <div className="para uppercase text-center leading-none z-40">
            <p style={{ WebkitTextStroke: "1px rgb(207, 205, 205)", WebkitTextFillColor: "transparent" }} className="z-10 font-bold text-lg -mb-5 tracking-wider text-gray-500">
          ...
          <div className="w-[230px] md:w-[230px] lg:w-[400px] aspect-square relative z-10 after:absolute after:h-1 after:w-full after:opacity-0 after:bg-[#7b956a] after:top-8 after:left-0 after:group-hover:opacity-100 after:translate-x-1/2 after:translate-y-1/2 after: after:group-hover:w-full after:transition-all after:duration-300 after:group-hover:origin-right after:group-hover:-translate-x-1/2 group-hover:translate-x-1/2 transition-all duration-300">
            ...
            <div className="tooltips absolute top-0 left-0 -translate-x-[100%] p-2 flex flex-col items-end gap-5 transition-all duration-300 group-hover:-translate-x-3/4">
