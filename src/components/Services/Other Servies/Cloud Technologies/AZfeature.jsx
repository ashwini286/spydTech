          ...
          <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="lg:pr-4">
              ...
              >
                <img
                  ...
                  src="https://www.cms.dtidigital.com.br/wp-content/uploads/elementor/thumbs/cloud-oqhqm71a7pseeasblz40ha09qgmwlw0peoufe21cvw.jpeg"
                  alt=""
                />
                ...
                <figure data-aos="fade-up-right" class="relative isolate">
                  ...
                  <blockquote class="mt-6 text-xl font-semibold leading-8 text-white">
                    <p>
                      “"Creating content for a website about a technology like
                      SpY D on the Azure Cloud platform would involve explaining
                      what SpY D Technology is, its features, benefits, and
                      possibly how it integrates or utilizes Azure services.
                      Here's a sample outline for the content: "{" "}
                    </p>
                  </blockquote>
            ...
            <div>
              <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
                <p
                  class="text-base font-semibold leading-7 text-yellow-400"
                  data-aos="fade-up-right"
                >
                  Features
                </p>
                ...
                <div class="max-w-xl" data-aos="fade-up-right">
                  <p class="mt-6">
                    Detailed breakdown of SPYD's features, including:
                  </p>
              ...
              <div class="mt-10 flex">
                <a
                  href="#"
                  class="text-base font-semibold leading-7 text-yellow-500"
                  data-aos="fade-up-right"
                >
          ...
          <div class="mx-auto flex flex-col items-center py-12 sm:py-24">
            ...
            >
              ...
              <p
                ...
                data-aos="fade-up-right"
              >
                Call-to-action prompting visitors to explore further or contact
                for more information. Links to resources like documentation,
