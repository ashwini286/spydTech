...
<div className="max-w-7xl mx-auto py-6 sm:px-6 sm:py-12 md:px-12 md:py-24">
    <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/3 md:w-1/4 p-10 prose" 
           
           >
            <h1  data-aos="fade-up-right"  className="text-2xl md:text-7xl   text-gray-600 leading-tight">Welcome to SpY D Technology's on Azure Cloud</h1>
            
               
                
            
            <p data-aos="fade-up-right" className="text-2xl text-gray-600 font-light mt-8 leading-relaxed">
        ...
        <div className="w-full lg:w-2/3 py-8 px-10 grid grid-cols-4 gap-4"
           data-aos="fade-up-right"
          >
            <div data-aos="fade-up-right"  className="h-64 col-span-4 sm:col-span-4 relative">
            ...
            <div data-aos="fade-up-right"  className="h-64 col-span-4 sm:col-span-2 relative">
            ...
            <div data-aos="fade-up-right"  className="h-64 col-span-4 sm:col-span-3 relative">
            ...
            <div data-aos="fade-up-right"  className="h-64 col-span-4 sm:col-span-1 relative">
...
<section class="bg-indigo-600 text-white py-20 px-4">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div class="md:w-1/2 mb-10 md:mb-0">
            ...
            <button data-aos="fade-up-right" class="bg-white text-indigo-600 font-bold py-3 px-6 rounded hover:bg-indigo-600 hover:text-white">Get Started</button>
        </div>
