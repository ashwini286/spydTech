  ...
  return (
    <>
      ...
      <div className="p-10 flex flex-col md:flex-row md:mt-5  gap-8">
        <img data-aos="fade-up" src={IMG2} className="shadow-xl  rounded-2xl" />
        <div className="md:p-10" data-aos="fade-right">
          <h1 className="text-4xl">ETL Testing </h1>
          <p>
            ETL in testing means an extract, transform and load process that
            reads data from multiple source systems, transports it to a data
            transformation layer for further processing which includes cleaning,
            consolidating, integrating, and then loading into a target database
            or file.
          </p>
        </div>
      </div>
      <div className="p-10 flex flex-col-reverse md:flex-row md:mt-5  gap-8">
        <div className="md:p-5" data-aos="fade-left">
          ...
          <p>
            ...
            etc to create Selenium Test Scripts. Testing done using the Selenium
            testing tool is usually referred to as Selenium Testing.
          </p>
        </div>
        <img src={IMG3} className="shadow-xl rounded-2xl" data-aos="fade-up" />
      </div>
      ...
      <div className="p-10 flex flex-col md:flex-row md:mt-5  gap-8">
        ...
        <div className="md:p-10" data-aos="fade-right">
          ...
          <p>
            Quality assurance testing, or QA testing, is a vital step in the
            software development cycle. Effective QA testing reveals errors and
            inconsistencies that can affect the real-world use of the software
            being developed. When done correctly, QA testing ensures product
            longevity while saving companies time and money.
          </p>
        </div>
      </div>
      ...
      <div className="p-10 flex flex-col-reverse md:flex-row md:mt-5 gap-8">
        <div className="md:p-5" data-aos="fade-left">
          ...
          <p>
            ...
            defects. It requires a tester to play the role of an end user where
            by they use most of the application's features to ensure correct
            behaviour.
          </p>
        </div>
        <img src={IMG5} className="shadow-xl rounded-2xl" data-aos="fade-up" />
      </div>
