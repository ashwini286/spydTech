...
const Benefits = () => {
  ...
  return (
    <>
      <div className=' md:px-8 pb-16 bg-gray-300 py-8 my-8' data-aos="fade-down">
        <div className='md:text-5xl md:font-extrabold text-2xl font-bold pl-12 pb-4 text-center'>
  ...
  <div className='flex items-center w-[89%] gap-4 pb-8 pl-2' >
  <p><VerifiedIcon /></p>
    <p>AngularJS provides two-way data binding, which allows automatic synchronization of data between the model and the view, reducing the need for manual intervention and making development faster and more efficient.</p>
  </div>
</div>
