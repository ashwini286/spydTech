        ...
        <div className='grid lg:grid-cols-6 md:px-20 px-4 pb-8 gap-2' data-aos="fade-down">
          ...
          <di v className='relative inset-0 flex items-center justify-center hover:-translate-y-4 transition-all duration-300'>
            ...
            <div className='absolute'>
              ...
              <p className='text-black text-center w-[189px] text-xs'>Creating a strategic plan after in-depth analysis of the current and future state.</p>
            </div>
          </di>
          ...
          <div className='relative inset-0 flex items-center justify-center hover:-translate-y-4 transition-all duration-300'>
            ...
            <div className='absolute'>
              ...
              <p className='text-black text-center w-[189px] text-xs'>Combining Strategic product solutions, and user’s goal through wireframes and prototypes.</p>
            </div>
          </div>
          ...
          <div className='relative inset-0 flex items-center justify-center hover:-translate-y-4 transition-all duration-300'>
            ...
            <div className='absolute'>
              ...
              <p className='text-black text-center w-[189px] text-xs'>Designing visual identity to strengthen brand through iconography color, type, imagery, and animation.</p>
            </div>
          </div>
          ...
          <div className='relative inset-0 flex items-center justify-center hover:-translate-y-4 transition-all duration-300'>
            ...
            <div className='absolute'>
              ...
              <p className='text-black text-center w-[189px] text-xs'>Using agile methodologies, our professionals build final product with creativity and deliver product that perform well.</p>
            </div>
          </div>
          ...
          <div className='relative inset-0 flex items-center justify-center hover:-translate-y-4 transition-all duration-300'>
            ...
            <div className='absolute'>
              ...
              <p className='text-black text-center w-[189px] text-xs'>Testing final product with all its features to check its performance and finally, handover to candidate for submission.</p>
            </div>
          </div>
          ...
          <div className='relative inset-0 flex items-center justify-center hover:-translate-y-4 transition-all duration-300'>
            ...
            <div className='absolute'>
              ...
              <p className='text-black text-center w-[189px] text-xs'>Evaluating the product’s performance and target the success metrics that was established in planning</p>
            </div>
          </div>
