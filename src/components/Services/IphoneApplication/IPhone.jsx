  ...
  return (
    <>
      ...
      <div className='md:px-16 px-4 py-4'>
        <h2 className=' text-2xl md:text-4xl font-bold mb-4 text-black text-center py-4' data-aos="fade-up">Empowering Your Ideas with iPhone App Development</h2>
        ...
        <br />
        <p className='text-black py-4' data-aos="fade-up">
        ...
        <p className='text-black pb-4' data-aos="fade-up">
