  ...
  return (
    ...
    <div className=' md:pt-16 pt-8 md:pl-24' >
        <div className='flex justify-center items-center flex-col' data-aos="fade-up">
            <div className='md:text-4xl  text-[#656565] mb-4 text-2xl'>
                Why Go NextJS
            </div>
            <div className='text-xl  text-[#656565] text-center '>
