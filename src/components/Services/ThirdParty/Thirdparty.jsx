        ...
        <ul class="pb-5 space-y-3 font-medium">
          ...
          <li class="flex items-start mt-5 lg:col-span-1 lg:mt-0">
            ...
            <p class="ml-3 leading-5 text-gray-600">
              ...
              by a third-party, usually (but not necessarily) large enterprises,
              to enable you to access their data or software functionalities on
              your enterprise-level software, application, or website.
            </p>
          </li>
        </ul>
      </div>
        ...
        <ul class="pb-5 space-y-3 font-medium">
          <li class="flex items-start lg:col-span-1">
            ...
            <p class="ml-3 leading-5 text-gray-600">
              ...
              part of a business now a day. Post pandemic Enterprises across the
              globe invested in ERP to make it more efficient, data-driven, and
              seamless.
            </p>
          </li>
          <li class="flex items-start mt-5 lg:col-span-1 lg:mt-0">
            ...
            <p class="ml-3 leading-5 text-gray-600">
              Considering the present scenario of the E-commerce sector or other
              business, where an item is being sold via multiple channels and
              platforms. And, it becomes a tedious task for the company to
              manage data in a centralized system. Also, it’s wholly useless
              without a central database and centralized system. Because the
              central database helps you to generate a different kind of
      ...
      <div>
        <ul class="pb-5 space-y-3 font-medium">
          <li class="flex items-start lg:col-span-1">
            ...
            <p class="ml-3 leading-5 text-gray-600">
              Most AGILE ERP is ERPNext because if you have ERPnext as your core
              system, you are free to integrate the platform with any of the
              third-party services and for analysis, it’s really easy to connect
              it with any analytics tools like Metabase or Power BI.
            </p>
          </li>
        </ul>
      </div>
...
<div className="md:text-center  text-2xl md:text-4xl tracking-wider pb-5 font-bold">
      ...
      <div className="tracking-wider pb-5 pl-[40px]">
        Akhilam Inc. is a diverse team of ERP, ERPNext Consultants, Developers,
        and Professionals with an infinite mindset and a collaborative culture.
        And, over the years, we have done many API integrations and a few of
      ...
      <div>
        <ul class="pb-5 space-y-3 font-medium">
          <li class="flex items-start lg:col-span-1">
            ...
            <p class="ml-3 leading-5 text-gray-600">
              DHL Shipment Integration With ERPNext —Autofetch DHL Shipment Into
              ERPNext
            </p>
          </li>
          <li class="flex items-start mt-5 lg:col-span-1 lg:mt-0">
            ...
            <p class="ml-3 leading-5 text-gray-600">
              Lazada E-Commerce Integration With ERPNext – API to Sync Data from
              Lazada Seller to ERPNext
            </p>
          </li>
          <li class="flex items-start mt-5 lg:col-span-1 lg:mt-0">
            <div class="flex-shrink-0">
