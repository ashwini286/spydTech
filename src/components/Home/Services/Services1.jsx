    ...
    <div>
      {isLoading ? (
        ...
        <div className="max-w-screen-2xl mx-auto">
          <div
            className="md:mt-20 md:w-2/2 mx-auto text-center w-full mt-8"
            data-aos="fade-up"
          >
            <div className="text-container">
              ...
              <p className="text-black px-4 md:text-xl font-sans">
                ...
                technologies offering wide range, wide spectrum services and
                solutions in areas such as Web Technologies, Mobility
                Applications, Web & Mobile Products, Custom Applications,
                End-to-End Digital Transformation, Augmented and Virtual
                reality, and Design Thinking Innovation and Digital Marketing
                Services.
              </p>
            </div>
          </div>
          ...
          <div className="md:px-14 px-4 max-w-screen-2xl mx-auto">
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl text-black font-normal mb-3">
