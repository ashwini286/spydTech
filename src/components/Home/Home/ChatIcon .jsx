...
const ChatIcon = ({ onClick }) => {
  return (
    <div className=" tooltip-container fixed bottom-8 right-8 bg-blue-500 rounded-full w-12 h-12 flex items-center justify-center text-white cursor-pointer shadow-lg">
      <svg id="Calque_1" viewBox="0 0 377 270" xmlns="http://www.w3.org/2000/svg"  onClick={onClick}>
    <g id="phone">
