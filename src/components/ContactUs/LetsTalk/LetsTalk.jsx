                ...
                <Card color="transparent" shadow={false}>
                  ...
                  <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-80">
                    <div className="mb-1 flex flex-col gap-6">
                      <Input color="white" label="Name" className='rounded-none ' />
                      <Input color="white" label="Email" className='rounded-none ' />
                      <Input color="white" label="Phone No" className='rounded-none ' />
                      <div className="w-86 border-0">
                        <Textarea color="blue" label="Message" variant="outlined" className='rounded-none ' />
                      </div>
                    </div>
